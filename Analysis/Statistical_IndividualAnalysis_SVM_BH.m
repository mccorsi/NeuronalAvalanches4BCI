function Statistical_IndividualAnalysis_SVM_BH(filename_Avalanches_subj, filename_Avalanches_subj_file, fig_path, db_path, numperm, nb_ROIs_DK, p_thresh, cortex_15002V_MNI, idx_DK)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Perform individual-level statistical analysis  trials from SVM
    % classif
    % Authors: MCC
    % Date: 23/03/2023
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
colorbar
caxis([0 0.05])
filename=strcat(fig_path,'MI_vs_Rest_SVM_Edges_diff_BH_corrected_p_thresh_', num2str(p_thresh), '_',filename_Avalanches_subj_file);
saveas(gcf,strcat(filename,'.pdf'));


save(strcat(db_path,'Stat_Analysis_Indiv_SVM_',filename_Avalanches_subj_file,'_BH_p_thresh_',num2str(p_thresh),'.mat'),...
