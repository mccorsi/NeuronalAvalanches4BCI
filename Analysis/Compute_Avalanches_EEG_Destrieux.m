...
nb_subj=size(Data_EEG_Baseline_Destrieux, 1); % numeri di soggetti
nb_ROIs=size(Data_EEG_Baseline_Destrieux{1,1}, 1); % x verificare il numero di ROIs
nbsamples =size(Data_EEG_Baseline_Destrieux{1,1}, 2); % numero di campioni
ROIs = [1:nb_ROIs]; 
thresh = z_thresh;
