...
nb_subj=size(Data_EEG_Baseline_DK, 1); % number of subjects
nb_ROIs=size(Data_EEG_Baseline_DK{1,1}, 1); % to check the number of ROIs
nbsamples =size(Data_EEG_Baseline_DK{1,1}, 2); % number of samples
ROIs = [1:nb_ROIs]; 
thresh = z_thresh;
